...
module.exports = function placeholder(passport) {
  passport.use('local-signup', new LocalStrategy({
    usernameField: 'email',
    passwordField: 'password',
    passReqToCallback: true
  },
    function pc2(req, email, password, done) {
      process.nextTick(function pc3() {
        User.findOne({'local.email': email}, functionpc4 (err, user) {
